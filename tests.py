...
class TestStar(unittest.TestCase):
    ...
    def test_constructs_correct_machine(self):
        ...
        self.assertTrue(self.regex.nfa.start_state.out1.char == '')
        self.assertTrue(self.regex.nfa.start_state.out1.to_state.out1.char == 'a')
        self.assertTrue(self.regex.nfa.start_state.out1.to_state.out1.to_state.is_match)
        self.assertTrue(self.regex.nfa.start_state.out1.to_state.out1.to_state.out1.char == '')
        self.assertTrue(self.regex.nfa.start_state.out1.to_state.out1.to_state.out1.to_state ==
                        self.regex.nfa.start_state.out1.to_state)
...
class TestConcatStar(unittest.TestCase):
    ...
    def test_constructs_correct_machine(self):
        ...
        self.assertTrue(self.regex.nfa.start_state.out1.to_state.out1.to_state.is_match)
        self.assertTrue(self.regex.nfa.start_state.out1.to_state.out1.to_state.out1.char == '')
        self.assertFalse(self.regex.nfa.start_state.out1.to_state.out1.to_state.out1.to_state.is_match)
        self.assertTrue(self.regex.nfa.start_state.out1.to_state.out1.to_state.out1.to_state.out1.char == 'b')
        self.assertTrue(self.regex.nfa.start_state.out1.to_state.out1.to_state.out1.to_state.out1.to_state.is_match)
        self.assertTrue(self.regex.nfa.start_state.out1.to_state.out1.to_state.out1.to_state.out1.to_state.out1.char ==
                        '')
        self.assertTrue(self.regex.nfa.start_state.out1.to_state.out1.to_state.out1.to_state.out1.to_state.out1.to_state ==
                        self.regex.nfa.start_state.out1.to_state.out1.to_state.out1.to_state)
